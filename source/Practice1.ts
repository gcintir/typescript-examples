...
var course_1 = new Course(1, 'Math', 6);
var course_2 = new Course(2, 'Algorithms', 4);
var course_3 = new Course(3, 'OOP', 3);

var courses:Array<Course> = [course_1, course_2, course_3];
console.log(courses);
